  ...
  return (
    <header className="bg-gradient-to-r from-nav to-[#04293a] text-white px-6 flex items-center h-16 shrink-0">
      ...
      <div className="flex gap-3 items-center pr-6 border-r border-white/12 mr-4">
        <div className="w-9 h-9 rounded-xl border-2 border-white/75 grid place-items-center text-lg">
          ♡
        </div>
        <div>
      ...
      <nav className="flex items-center gap-1.5 flex-1 overflow-x-auto hide-scrollbar">
        ...
        {/* Static Links */}
        <div className="flex items-center gap-2 px-3.5 py-2 text-[#d8eef4]/78 text-[13px] font-bold cursor-default whitespace-nowrap">⌂ Dashboard</div>
        <div className="flex items-center gap-2 px-3.5 py-2 text-[#d8eef4]/78 text-[13px] font-bold cursor-default whitespace-nowrap">◴ Appointment</div>
        <div className="flex items-center gap-2 px-3.5 py-2 text-[#d8eef4]/78 text-[13px] font-bold cursor-default whitespace-nowrap">☷ Queue / Flow</div>
        <div className="flex items-center gap-2 px-3.5 py-2 text-[#d8eef4]/78 text-[13px] font-bold cursor-default whitespace-nowrap">🐾 Patient Chart</div>
        <div className="flex items-center gap-2 px-3.5 py-2 text-[#d8eef4]/78 text-[13px] font-bold cursor-default whitespace-nowrap">▣ IPD / ICU</div>
      </nav>

      {/* Right Menu */}
      <div className="flex gap-4 items-center text-[#cfe4eb] text-[13px] ml-4 border-l border-white/12 pl-4 whitespace-nowrap">
        <span className="cursor-pointer hover:text-white transition-colors">⎋ Log out</span>
      </div>
