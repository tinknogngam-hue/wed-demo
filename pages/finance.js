...
import {
  ...
  Plus, Download, Search, CheckCircle2, ChevronRight,
  BarChart2, Tag, CreditCard,
} from 'lucide-react';
    ...
    <div className="h-full overflow-y-auto bg-[#f0f5f8] px-5 py-4 flex flex-col gap-3">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <button className="flex items-center gap-1.5 px-3 py-2 border border-[#e3edf3] bg-white rounded-lg text-[12px] text-[#64788a] hover:bg-[#f0f5f8] cursor-pointer shadow-sm">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[11px] bg-orange-50 text-orange-600 font-semibold px-2 py-0.5 rounded-full">
                    ฿61,350 คงค้าง
                  </span>
                </div>
                <table className="w-full text-[13px]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button className="flex items-center gap-1.5 bg-[#0f8f83] hover:bg-[#0a7a70] text-white text-[12px] font-semibold px-3 py-1.5 rounded-lg cursor-pointer">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button className="flex items-center gap-1.5 border border-[#0f8f83] text-[#0f8f83] hover:bg-[#e9f7f4] text-[12px] font-semibold px-3 py-1.5 rounded-lg cursor-pointer">
